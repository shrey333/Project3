...
parser.add_argument(
    "--access_key", type=str, help="ACCCESS KEY of the grading IAM user"
)
parser.add_argument("--secret_key", type=str, help="SECRET KEY of the grading IAM user")
parser.add_argument(
    "--input_bucket", type=str, help="Name of the input bucket, e.g. 1234567890-input"
)
parser.add_argument(
    "--output_bucket",
    type=str,
    help="Name of the output bucket, e.g. 1234567890-stage-1",
)
parser.add_argument(
    "--testcase_folder",
    type=str,
